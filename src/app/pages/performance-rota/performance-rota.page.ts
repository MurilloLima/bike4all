...
declare var Chart;
@Component({
  selector: 'app-performance-rota',
  templateUrl: './performance-rota.page.html',
  styleUrls: ['./performance-rota.page.scss'],
})
export class PerformanceRotaPage implements OnInit {
  ...
  loadGrafico(tipo:any){
    ...
    var canvas:any = document.getElementById('graficoPerformanceRota');
